######################################################################################
# Temperature_Humidity_plot_and_upload_v1.1.py
...
if model not in [u"DS18B20", u"DHT22"]:
	...
	sys.exit()
file_name = u"%s_%s.png"%(model, timestamp)
...
if model == u"DS18B20":
	...
	temperature.pop(0) # remove the first item of each list ("Measurements" and "Temperature" and "Time")
	...
	temperature = worksheet1.col_values(1)
	temperature.pop(0)
	humidity = worksheet1.col_values(2)
	humidity.pop(0)
	time = worksheet1.col_values(3)
	time.pop(0)
...
if model == u"DS18B20":
	data_to_be_uploaded = {u"Model": model, u"Measurements": measurement, u"Temperature": temperature, u"Time": time}
elif model == u"DHT22":
	data_to_be_uploaded = {u"Model": model, u"Measurements": measurement, u"Temperature": temperature, u"humidity": humidity, u"Time": time}
